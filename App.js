...
const image = {
  uri: 'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/sunset-quotes-21-1586531574.jpg',
};
const App = () => {
            ...
            <View style={styles.view_bottom}>
              ...
              <View style={styles.description_secondary}>
                <View
                  ...
                  <Text style={styles.view_secondaryStyle}>
